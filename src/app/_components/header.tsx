...
export function Header() {
  return (
    <header className="text fixed bottom-2 left-2 right-2 z-20  flex h-12 items-center justify-between bg-textColor p-3 py-2 lg:sticky lg:top-2 lg:mx-2 lg:px-5 lg:py-3">
      <HeaderLeftNav />

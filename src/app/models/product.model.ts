...
const typeMap: any = {
  "Product": o([
      { json: "product", js: "product", typ: r("ProductClass") },
  ], false),
  "ProductClass": o([
      { json: "id", js: "id", typ: 0 },
      ...
      { json: "availableSizes", js: "availableSizes", typ: r("AvailableSizes") },
      { json: "description", js: "description", typ: "" },
      { json: "categories", js: "categories", typ: a("") },
      { json: "productImages", js: "productImages", typ: a("") },
  ], false),
  "AvailableSizes": o([
      { json: "os", js: "os", typ: 0 },
      { json: "xxs", js: "xxs", typ: 0 },
      { json: "xs", js: "xs", typ: 0 },
      { json: "s", js: "s", typ: 0 },
      { json: "m", js: "m", typ: 0 },
      { json: "l", js: "l", typ: 0 },
  ...
  "Price": o([
      { json: "usd", js: "usd", typ: 0 },
      { json: "rub", js: "rub", typ: 0 },
      { json: "byn", js: "byn", typ: 0 },
      { json: "eur", js: "eur", typ: 0 },
  ], false),
};

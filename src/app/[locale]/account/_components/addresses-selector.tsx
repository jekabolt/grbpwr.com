...
export function AddressesSelector({
  ...
  return (
    ...
    >
      <RadixSelect.Trigger
        className={cn(
          "flex w-full items-center gap-1.5 bg-bgColor text-left text-textBaseSize leading-none underline disabled:border-textInactiveColor disabled:text-textInactiveColor",
        )}

...
export function HeaderArchive({ left, center, link }: HeaderProps) {
  ...
  return (
    <header
      className={cn(
        "blackTheme fixed inset-x-2.5 top-2 z-[100] flex h-12 items-center border border-textInactiveColor bg-bgColor py-2 text-textColor lg:gap-0 lg:border-transparent lg:px-5 lg:py-3 lg:text-textColor lg:mix-blend-exclusion",

export default function Component() {
  return (
    <div className="prose">
      ...
      publishing industries for previewing layouts and visual mockups. TERMS AND
      CONDITIONS OVERVIEW This website is managed by GRBPWR. Throughout the
      site, the terms “we”, “us”, and “our” refer to GRBPWR. GRBPWR provides
      this website, which includes all information, tools, and services
      available to you, the user, conditioned upon your acceptance of all terms,
      conditions, policies, and notices stated here. By accessing our site
      and/or purchasing something from us, you participate in our “Service” and
      agree to be bound by the terms and conditions (“Terms of Service”,
      “Terms”), including additional terms and conditions and policies
      referenced herein and/or available by hyperlink. These Terms of Service
      apply to all users of the site, including browsers, vendors, customers,
      merchants, and content contributors. Please read these Terms of Service
      carefully before using our website. By using any part of the site, you
      agree to these Terms of Service. If you disagree with any part of the
      terms and conditions, then you should not access the website or use any
      services. If these Terms of Service are considered an offer, acceptance is
      expressly limited to these Terms. New features or tools added to the
      current store will also be subject to the Terms of Service. You can review
      the most current version of the Terms of Service at any time on this page.
      We reserve the right to update, change, or replace any part of these Terms
      of Service by posting updates and/or changes on our website. It is your
      ...
      constitutes acceptance of those changes. Section 2 - ONLINE STORE TERMS By
      agreeing to these Terms of Service, you confirm that you are at least the
      age of majority in your state or province of residence, or that you have
      given us your consent to allow any of your minor dependents to use this
      site. You must not use our products for any illegal or unauthorized
      purpose, nor may you, in the use of the Service, violate any laws in your
      jurisdiction. You must not transmit any worms, viruses, or any code of a
      destructive nature. A breach or violation of any of the Terms will result
      in an immediate termination of your Services. Section 2 - GENERAL
      CONDITIONS We reserve the right to refuse service to anyone for any reason
      at any time. Your content may be transferred unencrypted and involve
      ...
      written permission by us. Section 3 - ACCURACY, COMPLETENESS, AND
      ...
      consulting primary, more accurate, complete, or timely sources of
      information. Any reliance on the material on this site is at your own
      risk. This site may contain historical information, which is not current
      and is provided for your reference only. We reserve the right to modify
      ...
      errors in the Service will be corrected. Section 6 - ACCURACY OF BILLING
      AND ACCOUNT INFORMATION We reserve the right to refuse any order you place
      with us. We may, in our sole discretion, limit or cancel quantities
      ...
      to be placed by dealers, resellers, or distributors. You agree to provide
      ...
      other information, including your email address and credit card numbers
      ...
      available” without any warranties, representations, or conditions of any
      kind and without any endorsement. We shall have no liability whatsoever
      arising from or relating to your use of optional third-party tools. Any
      use by you of optional tools offered through the site is entirely at your
      ...
      submissions (e.g., contest entries) or without a request from us, you send
      ...
      website, except as required by law. No specified update or refresh date
      ...
      been modified or updated. Section 12 - PROHIBITED USES In addition to
      ...
      acts; © to violate any international, federal, provincial, or state
      ...
      website for violating any of the prohibited uses. Section 13 - DISCLAIMER
      OF WARRANTIES; LIMITATION OF LIABILITY We do not guarantee, represent, or
      ...
      and non-infringement. In no case shall GRBPWR, our directors, officers,
      ...
      INDEMNIFICATION You agree to indemnify, defend, and hold harmless GRBPWR
      ...
      third-party. Section 15 - SEVERABILITY In the event that any provision of
      ...
      construed in accordance with the laws of Poland.  Section 19 - CHANGES TO
      ...
      those changes. Section 20 - CONTACT INFORMATION Questions about the Terms
      of Service should be sent to us at info@grbpwr.com [COPY BUTTON]  Our
      contact information is posted below:  Trade name: GRBPWR Email:
      customercare@grbpwr.com [COPY BUTTON] Physical address: Poland Warszawa
      plac Zbawiciela 500-651 Warszawa VAT number: PL00000000000000 Trade
      number: 000000000000 
    </div>
  );
}

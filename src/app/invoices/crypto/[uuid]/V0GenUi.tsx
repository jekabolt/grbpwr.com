    ...
    <div className="mx-auto w-full space-y-4 p-40">
      ...
      <div className="flex flex-col border p-4 md:flex-row">
        <div className="flex items-center justify-center p-4">
          <img src="/placeholder.svg" alt="QR Code" className="h-40 w-40" />
        </div>
        <div className="flex-1 space-y-4 p-4">
          <div className="space-y-2">
            <div className="text-sm">send exact amount in one payment:</div>
            <div className="flex items-center space-x-2">
              <div className="text-2xl font-bold">{cryptoAmount} USDT</div>
              <button className="text-sm text-blue-500">copy</button>
            </div>

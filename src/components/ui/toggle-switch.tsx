...
export function ToggleSwitch({
  ...
  return (
    <div className="flex items-center gap-5">
      ...
      >
        <Switch.Thumb className="block h-2 w-2 translate-x-0.5 bg-textColor transition-transform duration-100 will-change-transform data-[state=checked]:translate-x-[13px] data-[state=checked]:bg-white" />
      </Switch.Root>
      {label && (

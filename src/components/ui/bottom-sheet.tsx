...
export function BottomSheet({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 scroll-smooth">
      ...
      >
        <div className="border-b-none pointer-events-auto h-full space-y-6 overflow-y-scroll border-x border-t border-textInactiveColor bg-bgColor px-2.5 pb-[max(8rem,env(safe-area-inset-bottom))] pt-2.5">
          {children}
        </div>
      </motion.div>
    </div>

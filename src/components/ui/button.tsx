  ...
  variants: {
    variant: {
      ...
      crossed: [
        ...
        "before:h-full",
        "before:content-['']",
        "before:bg-[linear-gradient(to_bottom_right,transparent_calc(50%-0.5px),var(--inactive)_calc(50%-0.5px),var(--inactive)_calc(50%+0.5px),transparent_calc(50%+0.5px))]",
        "after:absolute",
        "after:top-0",
        "after:left-0",
        "after:w-full",
        "after:h-full",
        "after:content-['']",
        "after:bg-[linear-gradient(to_bottom_left,transparent_calc(50%-0.5px),var(--inactive)_calc(50%-0.5px),var(--inactive)_calc(50%+0.5px),transparent_calc(50%+0.5px))]",

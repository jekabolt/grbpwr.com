...
export const COUNTRIES_BY_REGION = {
  AFRICA: [
    { name: 'south africa', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'ZA' },
  ],
  AMERICAS: [
    { name: 'canada', currency: 'C$', currencyKey: 'CAD', lng: 'en', countryCode: 'CA' },
    { name: 'chile', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'CL' },
    { name: 'mexico', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'MX' },
    { name: 'united states', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'US' },
  ],
  'ASIA PACIFIC': [
    { name: 'australia', currency: 'A$', currencyKey: 'AUD', lng: 'en', countryCode: 'AU' },
    { name: 'hong kong sar', currency: 'HK$', currencyKey: 'HKD', lng: 'en', countryCode: 'HK' },
    { name: 'india', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'IN' },
    { name: 'japan', currency: '¥', currencyKey: 'JPY', lng: 'en', countryCode: 'JP' },
    { name: '日本', currency: '¥', currencyKey: 'JPY', lng: 'ja', countryCode: 'JP', displayLng: '日本語' },
    { name: 'macau sar', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'MO' },
    { name: 'mainland china', currency: '¥', currencyKey: 'CNY', lng: 'en', countryCode: 'CN' },
    { name: '中国大陆', currency: '¥', currencyKey: 'CNY', lng: 'cn', countryCode: 'CN', displayLng: '简体中文' },
    { name: 'malaysia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'MY' },
    { name: 'new zealand', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'NZ' },
    { name: 'singapore', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'SG' },
    { name: 'south korea', currency: '₩', currencyKey: 'KRW', lng: 'en', countryCode: 'KR' },
    { name: '대한민국', currency: '₩', currencyKey: 'KRW', lng: 'kr', countryCode: 'KR', displayLng: '한국인' },
    { name: 'taiwan', currency: 'NT$', currencyKey: 'TWD', lng: 'en', countryCode: 'TW' },
    { name: '台湾地区', currency: 'NT$', currencyKey: 'TWD', lng: 'cn', countryCode: 'TW', displayLng: '繁體中文' },
    { name: 'thailand', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'TH' },
  ],
  EUROPE: [
    { name: 'aland islands', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'AX' },
    { name: 'andorra', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'AD' },
    { name: 'austria', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'AT' },
    { name: 'belgium', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'BE' },
    { name: 'bulgaria', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'BG' },
    { name: 'croatia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'HR' },
    { name: 'cyprus', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'CY' },
    { name: 'czech republic', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'CZ' },
    { name: 'denmark', currency: 'DKK', currencyKey: 'DKK', lng: 'en', countryCode: 'DK' },
    { name: 'estonia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'EE' },
    { name: 'faroe islands', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'FO' },
    { name: 'finland', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'FI' },
    { name: 'france', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'FR' },
    { name: 'france', currency: '€', currencyKey: 'EUR', lng: 'fr', countryCode: 'FR' },
    { name: 'germany', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'DE' },
    { name: 'deutschland', currency: '€', currencyKey: 'EUR', lng: 'de', countryCode: 'DE' },
    { name: 'gibraltar', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'GI' },
    { name: 'greece', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'GR' },
    { name: 'greenland', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'GL' },
    { name: 'guernsey', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'GG' },
    { name: 'hungary', currency: '€', currencyKey: 'HUF', lng: 'en', countryCode: 'HU' },
    { name: 'iceland', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'IS' },
    { name: 'italy', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'IT' },
    { name: 'italy', currency: '€', currencyKey: 'EUR', lng: 'it', countryCode: 'IT' },
    { name: 'jersey', currency: '€', currencyKey: 'GBP', lng: 'en', countryCode: 'JE' },
    { name: 'latvia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'LV' },
    { name: 'liechtenstein', currency: '€', currencyKey: 'CHF', lng: 'en', countryCode: 'LI' },
    { name: 'lithuania', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'LT' },
    { name: 'luxembourg', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'LU' },
    { name: 'malta', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'MT' },
    { name: 'monaco', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'MC' },
    { name: 'netherland', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'NL' },
    { name: 'norway', currency: 'NOK', currencyKey: 'NOK', lng: 'en', countryCode: 'NO' },
    { name: 'poland', currency: '€', currencyKey: 'PLN', lng: 'en', countryCode: 'PL' },
    { name: 'portugal', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'PT' },
    { name: 'romania', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'RO' },
    { name: 'slovakia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'SK' },
    { name: 'slovenia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'SI' },
    { name: 'spain', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'ES' },
    { name: 'sweeden', currency: 'SEK', currencyKey: 'SEK', lng: 'en', countryCode: 'SE' },
    { name: 'switzerland', currency: '€', currencyKey: 'CHF', lng: 'en', countryCode: 'CH' },
    { name: 'turkey', currency: '€', currencyKey: 'TRY', lng: 'en', countryCode: 'TR' },
    { name: 'united kingdom', currency: '£', currencyKey: 'GBP', lng: 'en', countryCode: 'GB' },
  ],
  'MIDDLE EAST': [
    { name: 'bahrain', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'BH' },
    { name: 'israel', currency: '€', currencyKey: 'ILS', lng: 'en', countryCode: 'IL' },
    { name: 'kuwait', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'KW' },
    { name: 'qatar', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'QA' },
    { name: 'saudi arabia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'SA' },
    { name: 'united arab emirates', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'AE' },
  ],

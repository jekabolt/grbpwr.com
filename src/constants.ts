...
export const COUNTRIES_BY_REGION = {
  ...
  AMERICAS: [
    { name: 'canada', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'ca', displayLng: 'english' },
  ...
  'ASIA PACIFIC': [
    { name: 'australia', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'au', displayLng: 'english' },
    { name: 'hong kong sar', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'hk', displayLng: 'english' },
    ...
    { name: 'south korea', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'kr', displayLng: 'english' },
    { name: '대한민국', currency: '€', currencyKey: 'EUR', lng: 'ko', countryCode: 'kr', displayLng: '한국인' },
    { name: 'taiwan', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'tw', displayLng: 'english' },
    { name: '台湾地区', currency: '$', currencyKey: 'USD', lng: 'zh', countryCode: 'tw', displayLng: '繁體中文' },
  ...
  EUROPE: [
    ...
    { name: 'denmark', currency: 'kr', currencyKey: 'DKK', lng: 'en', countryCode: 'dk', displayLng: 'english' },
    ...
    { name: 'norway', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'no', displayLng: 'english' },
    ...
    { name: 'sweeden', currency: 'kr', currencyKey: 'SEK', lng: 'en', countryCode: 'se', displayLng: 'english' },

...
export const COUNTRIES_BY_REGION = {
  AFRICA: [
    { name: 'south africa', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'za', displayLng: 'english' },
  ],
  AMERICAS: [
    { name: 'canada', currency: 'C$', currencyKey: 'CAD', lng: 'en', countryCode: 'ca', displayLng: 'english' },
    { name: 'chile', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'cl', displayLng: 'english' },
    { name: 'mexico', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'mx', displayLng: 'english' },
    { name: 'united states', currency: '$', currencyKey: 'USD', lng: 'en', countryCode: 'us', displayLng: 'english' },
  ],
  'ASIA PACIFIC': [
    { name: 'australia', currency: 'A$', currencyKey: 'AUD', lng: 'en', countryCode: 'au', displayLng: 'english' },
    { name: 'hong kong sar', currency: 'HK$', currencyKey: 'HKD', lng: 'en', countryCode: 'hk', displayLng: 'english' },
    { name: 'india', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'in', displayLng: 'english' },
    { name: 'japan', currency: '¥', currencyKey: 'JPY', lng: 'en', countryCode: 'jp', displayLng: 'english' },
    { name: '日本', currency: '¥', currencyKey: 'JPY', lng: 'ja', countryCode: 'jp', displayLng: '日本語' },
    { name: 'macau sar', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'mo', displayLng: 'english' },
    { name: 'mainland china', currency: '¥', currencyKey: 'CNY', lng: 'en', countryCode: 'cn', displayLng: 'english' },
    { name: '中国大陆', currency: '¥', currencyKey: 'CNY', lng: 'zh', countryCode: 'cn', displayLng: '简体中文' },
    { name: 'malaysia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'my', displayLng: 'english' },
    { name: 'new zealand', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'nz', displayLng: 'english' },
    { name: 'singapore', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'sg', displayLng: 'english' },
    { name: 'south korea', currency: '₩', currencyKey: 'KRW', lng: 'en', countryCode: 'kr', displayLng: 'english' },
    { name: '대한민국', currency: '₩', currencyKey: 'KRW', lng: 'ko', countryCode: 'kr', displayLng: '한국인' },
    { name: 'taiwan', currency: 'NT$', currencyKey: 'TWD', lng: 'en', countryCode: 'tw', displayLng: 'english' },
    { name: '台湾地区', currency: 'NT$', currencyKey: 'TWD', lng: 'zh', countryCode: 'tw', displayLng: '繁體中文' },
    { name: 'thailand', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'th', displayLng: 'english' },
  ],
  EUROPE: [
    { name: 'aland islands', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'ax', displayLng: 'english' },
    { name: 'andorra', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'ad', displayLng: 'english' },
    { name: 'austria', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'at', displayLng: 'english' },
    { name: 'belgium', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'be', displayLng: 'english' },
    { name: 'bulgaria', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'bg', displayLng: 'english' },
    { name: 'croatia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'hr', displayLng: 'english' },
    { name: 'cyprus', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'cy', displayLng: 'english' },
    { name: 'czech republic', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'cz', displayLng: 'english' },
    { name: 'denmark', currency: 'DKK', currencyKey: 'DKK', lng: 'en', countryCode: 'dk', displayLng: 'english' },
    { name: 'estonia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'ee', displayLng: 'english' },
    { name: 'faroe islands', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'fo', displayLng: 'english' },
    { name: 'finland', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'fi', displayLng: 'english' },
    { name: 'france', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'fr', displayLng: 'english' },
    { name: 'france', currency: '€', currencyKey: 'EUR', lng: 'fr', countryCode: 'fr', displayLng: 'français' },
    { name: 'germany', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'de', displayLng: 'english' },
    { name: 'deutschland', currency: '€', currencyKey: 'EUR', lng: 'de', countryCode: 'de', displayLng: 'deutsch' },
    { name: 'gibraltar', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'gi', displayLng: 'english' },
    { name: 'greece', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'gr', displayLng: 'english' },
    { name: 'greenland', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'gl', displayLng: 'english' },
    { name: 'guernsey', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'gg', displayLng: 'english' },
    { name: 'hungary', currency: '€', currencyKey: 'HUF', lng: 'en', countryCode: 'hu', displayLng: 'english' },
    { name: 'iceland', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'is', displayLng: 'english' },
    { name: 'italy', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'it', displayLng: 'english' },
    { name: 'italy', currency: '€', currencyKey: 'EUR', lng: 'it', countryCode: 'it', displayLng: 'italiano' },
    { name: 'jersey', currency: '€', currencyKey: 'GBP', lng: 'en', countryCode: 'je', displayLng: 'english' },
    { name: 'latvia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'lv', displayLng: 'english' },
    { name: 'liechtenstein', currency: '€', currencyKey: 'CHF', lng: 'en', countryCode: 'li', displayLng: 'english' },
    { name: 'lithuania', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'lt', displayLng: 'english' },
    { name: 'luxembourg', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'lu', displayLng: 'english' },
    { name: 'malta', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'mt', displayLng: 'english' },
    { name: 'monaco', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'mc', displayLng: 'english' },
    { name: 'netherland', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'nl', displayLng: 'english' },
    { name: 'norway', currency: 'NOK', currencyKey: 'NOK', lng: 'en', countryCode: 'no', displayLng: 'english' },
    { name: 'poland', currency: '€', currencyKey: 'PLN', lng: 'en', countryCode: 'pl', displayLng: 'english' },
    { name: 'portugal', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'pt', displayLng: 'english' },
    { name: 'romania', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'ro', displayLng: 'english' },
    { name: 'slovakia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'sk', displayLng: 'english' },
    { name: 'slovenia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'si', displayLng: 'english' },
    { name: 'spain', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'es', displayLng: 'english' },
    { name: 'sweeden', currency: 'SEK', currencyKey: 'SEK', lng: 'en', countryCode: 'se', displayLng: 'english' },
    { name: 'switzerland', currency: '€', currencyKey: 'CHF', lng: 'en', countryCode: 'ch', displayLng: 'english' },
    { name: 'turkey', currency: '€', currencyKey: 'TRY', lng: 'en', countryCode: 'tr', displayLng: 'english' },
    { name: 'united kingdom', currency: '£', currencyKey: 'GBP', lng: 'en', countryCode: 'gb', displayLng: 'english' },
  ],
  'MIDDLE EAST': [
    { name: 'bahrain', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'bh', displayLng: 'english' },
    { name: 'israel', currency: '€', currencyKey: 'ILS', lng: 'en', countryCode: 'il', displayLng: 'english' },
    { name: 'kuwait', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'kw', displayLng: 'english' },
    { name: 'qatar', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'qa', displayLng: 'english' },
    { name: 'saudi arabia', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'sa', displayLng: 'english' },
    { name: 'united arab emirates', currency: '€', currencyKey: 'EUR', lng: 'en', countryCode: 'ae', displayLng: 'english' },
  ],

...
export const COUNTRIES_BY_REGION = {
  ...
  'ASIA PACIFIC': [
    ...
    { name: '中国大陆', currency: '¥', currencyKey: 'CNY', lng: 'cn', countryCode: 'CN', displayLng: '简体中文' },
    ...
    { name: '대한민국', currency: '₩', currencyKey: 'KRW', lng: 'kr', countryCode: 'KR', displayLng: '한국인' },
    { name: 'taiwan', currency: 'NT$', currencyKey: 'TWD', lng: 'en', countryCode: 'TW', displayLng: 'english' },
    { name: '台湾地区', currency: 'NT$', currencyKey: 'TWD', lng: 'cn', countryCode: 'TW', displayLng: '繁體中文' },

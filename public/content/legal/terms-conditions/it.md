...
Questo sito web è di proprietà e gestito da GRBPWR Limited, una società costituita secondo le leggi del Regno Unito ("GRBPWR" o "noi", "nostro").

Leggere le seguenti Condizioni d'uso ("CU") prima di utilizzare questo sito web.
Le presenti Condizioni d'uso ("CU") regolano l'accesso e l'utilizzo di questo sito web e dei suoi servizi. Utilizzando il sito web, l'utente accetta di essere vincolato dalle presenti CU. Se non si accettano, si prega di interrompere l'utilizzo del sito.
Ci riserviamo il diritto di aggiornare le presenti Condizioni d'uso in qualsiasi momento. La versione più recente sarà sempre disponibile sul sito web con l'indicazione della data dell'"ultimo aggiornamento". Continuando a utilizzare il sito dopo le modifiche, l'utente accetta le Condizioni d'uso aggiornate.
...
2.2. Ci riserviamo il diritto di sospendere, limitare o interrompere l'accesso dell'utente al sito web e ai suoi servizi in qualsiasi momento, senza preavviso né responsabilità, in caso di violazione delle presenti Condizioni d'uso. Ciò non pregiudica qualsiasi altro rimedio legale a nostra disposizione. Ci riserviamo inoltre il diritto di rifiutare il servizio a qualsiasi persona a nostra discrezione, anche per motivi di prevenzione delle frodi e di sicurezza.

## SERVIZI ELETTRONICI

3.1. Potremmo contattarvi via e-mail per questioni relative al servizio (ad esempio, conferme d'ordine, aggiornamenti sulla spedizione e notifiche dell'account). Potremmo inoltre utilizzare il numero di telefono fornito durante il checkout per la coordinazione della consegna con i nostri partner di spedizione. Si prega di notare che, in alcune giurisdizioni, l'utilizzo dei servizi mobili può comportare costi da parte del proprio fornitore di rete, di cui l'utente è l'unico responsabile.
...
7.2. Nella misura massima consentita dalla legge, non saremo responsabili per danni indiretti, incidentali o consequenziali; qualsiasi perdita non correlata alla nostra violazione; problemi derivanti dall'uso o dall'impossibilità di utilizzare il sito web, i suoi contenuti, i servizi o qualsiasi link esterno; guasti tecnici quali ritardi, interruzioni del servizio, errori o virus; problemi di sicurezza relativi al vostro account; affidamento sull'accuratezza o la completezza del sito web; aggiornamenti o modifiche ai nostri servizi o contenuti; o eventuali ritardi o guasti causati da forza maggiore o eventi al di fuori del nostro ragionevole controllo.
...
Se avete un reclamo riguardante il sito web o i nostri servizi, contattateci utilizzando il modulo [Servizi post-vendita](/aftersale-services) sul sito web o inviateci un'e-mail a support@grbpwr.com.

## LEGGE APPLICABILE E FORO COMPETENTE

10.1. Le presenti Condizioni d'uso sono regolate e interpretate in conformità con le leggi dell'Inghilterra e del Galles, indipendentemente dal Paese dal quale si accede al sito web. Qualsiasi controversia derivante da o relativa alle presenti Condizioni sarà sottoposta alla giurisdizione non esclusiva dei tribunali dell'Inghilterra e del Galles, senza pregiudizio dei vostri diritti di agire dinanzi ai tribunali del luogo di residenza se richiesto dalle leggi applicabili in materia di tutela dei consumatori.

## DISPOSIZIONI GENERALI

11.1. **Separabilità.** Se una qualsiasi disposizione delle presenti Condizioni è ritenuta invalida o inapplicabile da un tribunale competente, tale disposizione sarà limitata o eliminata nella misura minima necessaria e le restanti disposizioni rimarranno pienamente in vigore.
11.2. **Intero accordo.** Le presenti Condizioni, insieme all'Informativa sulla privacy e a qualsiasi altro avviso legale pubblicato da noi sul sito web, costituiscono l'intero accordo tra l'utente e GRBPWR riguardante l'utilizzo del sito web e sostituiscono tutti gli accordi, dichiarazioni e intese precedenti o contemporanei.
11.3. **Nessuna rinuncia.** La nostra mancata applicazione di un diritto o di una disposizione delle presenti Condizioni non costituirà una rinuncia a tale diritto o disposizione. Qualsiasi rinuncia a una disposizione sarà efficace solo se fatta per iscritto e firmata da un rappresentante autorizzato di GRBPWR.
11.4. **Nessuna cessione.** Non potete cedere o trasferire le presenti Condizioni, o qualsiasi diritto o obbligo derivante, senza il nostro previo consenso scritto. Noi possiamo cedere o trasferire le presenti Condizioni in qualsiasi momento senza restrizioni.
11.5. **Lingua.** Le presenti Condizioni sono redatte in lingua inglese. In caso di conflitto tra una versione tradotta e la versione inglese, prevarrà la versione inglese.

...
当社の価格は、地域および選択に応じて、USD、EUR、GBP、JPY、CNY、または KRW で表示されます。

## 配送

料金と配送速度は、選択した地域によって異なります。選択した地域の一定金額以上のご注文については、送料無料の標準配送がご利用いただける場合があります（チェックアウト時に表示）。
...
注文到着後 14 日以内に返品できます。返品するには、[アフターサービス](/aftersale-services) ページの返品フォームに記入してください。返品用の先払い配送ラベルがメールで送付されます。可能な限り元の梱包材を使用し、商品を元の状態で丁寧に再梱包し、返品ラベルを貼付してから配送業者による集荷を手配してください。

損傷、着用、加工、またはタグや元の梱包材が欠けている商品は返品を受け付けません。

ご注文情報のページで返金状況を確認できます。

サイズや色違いで交換したい場合は、[アフターサービス](/aftersale-services) フォームをご利用ください。
...
注文を返品するには、[アフターサービス](/aftersale-services) ページの返品フォームに記入してください。返品用の先払い配送ラベルがメールで送付されます。

損傷、着用、加工、またはタグや元の梱包材が欠けている商品は返品を受け付けません。

サイズや色違いで交換したい場合は、[当社に連絡](/aftersale-services) してください。
...
サイズや色違いで交換する場合は、[当社に連絡](/aftersale-services) してください。

### 返金

返品注文を受け取り承認後、5〜7 営業日以内に返金処理を行います。返品を受け取り承認すると、確認メールが送信されます。返金ステータスはご注文情報で確認できます。

14 日間のキャンセル期間内の返品については、商品価格に加えて最も安価な標準配送料を返金いたします。返金は購入時に使用された元の支払方法と同じ通貨で行われます。
...
当社の製品またはサービスについて苦情がある場合は、[アフターサービス](/aftersale-services) フォームまたは [support@grbpwr.com](mailto:support@grbpwr.com) までご連絡ください。苦情を確認次第、速やかに対応いたします。
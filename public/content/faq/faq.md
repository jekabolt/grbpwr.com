...
- Once your payment is successfully processed via Stripe, your order is confirmed and a receipt with your order number will be sent to the email address you provided.

You can track your order status using your order reference and email [here](/order-status).

PAYMENT

You can pay for your order using major credit and debit cards, Apple Pay, PayPal, or Klarna. Please ensure that all entered details are correct before proceeding with the payment. All payments are securely processed via Stripe. Your card will be charged at checkout. We do not collect or store your full credit card details.
...
Our prices are displayed in USD, EUR, GBP, JPY, CNY, or KRW depending on your region and selection.

DELIVERY

The cost and delivery speed depend on the region selected. Free standard shipping may be available on orders above a threshold determined by your region; this will be displayed at checkout.
...
If your order contains a pre-order item, we will ship the whole order together when the pre-order is ready. The shipping date for pre-orders is shown on the product page. We do not offer split shipments.
...
You can return your order within 14 days of receiving it. To make a return, please fill out the returns form on our [Aftersale Services](/aftersale-services) page. You will receive a prepaid return shipping label by email. Carefully repackage the item(s) in their original condition, using the original packaging wherever possible, affix the return label, and arrange collection via the courier.

Items that are damaged, worn, altered, or missing labels and original packaging will not be accepted for return.

You can check the status of your refund in your order information on our website.

If you would like to exchange an item for a different size or colour, please use our [Aftersale Services](/aftersale-services) form.
...
Refunded
Your return has been received and processed by our warehouse. You can check the refund status in your order information.
...
Pre-order refers to an item that will soon be available for delivery. If your order contains a pre-order item, we will ship the whole order when the pre-order is ready. Payment is taken at checkout. The shipping date for pre-orders is shown on the product page.
...
Take clear photos of the damage and [contact us](/aftersale-services).

## RETURN, EXCHANGE AND REFUND

RETURN A PRODUCT

To return an order, please fill out the returns form on our [Aftersale Services](/aftersale-services) page. You will receive a prepaid return shipping label by email.

Items that are damaged, worn, altered, or missing tags and original packaging will not be accepted for return.

If you would like to exchange an item for a different size or colour, please [get in touch with us](/aftersale-services).
...
We cover the cost of returns by providing a prepaid return shipping label.

EXCHANGE REQUEST

To exchange an item for a different size or colour, please [contact us](/aftersale-services).

REFUND

We issue a refund within 5-7 days after the returned order is received and approved. Once we receive your return and it is approved, you will receive a confirmation email. You can check the status of your refund in your order information.

For returns within the 14-day cancellation period, we will refund the cheapest standard delivery cost in addition to the product price. Refunds are issued to the original payment method and in the same currency used for the purchase.
...
If you have a complaint about our products or services, please contact us using the [Aftersale Services](/aftersale-services) form on our website or email us at [support@grbpwr.com](mailto:support@grbpwr.com). We will acknowledge your complaint promptly and aim to resolve it as soon as possible.
